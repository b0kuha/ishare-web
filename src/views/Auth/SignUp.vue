<template>
  <v-container class="fill-height" fluid>
    <v-row>
      <v-col class="ma-auto" cols="12" lg="7" md="8" sm="8" xs="12">
        <v-card class="px-4 pt-6 pb-12" outlined>
          <v-row class="justify-space-between">
            <v-col cols="6">
              <v-card-title class="text-center">iShare</v-card-title>
              <v-card-subtitle class="mb-5">注册一个iShare账号</v-card-subtitle>
              <v-card-text>
            ...
            <v-col class="align-self-center" cols="5">
              <v-responsive>
                <svg id="b59c9f89-c93e-413f-a14b-776784e615e2"
                     data-name="Layer 1"
                     style="max-width: 100%"
                  ...
                  <path
                      ...
                      transform="translate(-62.24207 -126.55043)"
                  />
                  <ellipse cx="536" cy="625.89913" fill="#d0cde1" rx="536" ry="21"/>
                  <rect fill="#3f3d56" height="364.87" width="612" x="184" y="248.03055"/>
                  <path
                  ...
                  <path d="M858.24207,550.72094v122.9a61.52336,61.52336,0,0,1,0-122.9Z"
                        fill="#2b81d6"
                        transform="translate(-62.24207 -126.55043)"/>
                  <rect fill="#fff" height="36.06239" rx="18.03118" width="422.14211" x="279.45927" y="380.6149"/>
                  <rect fill="#fff" height="36.06239" rx="18.03118" width="422.14211" x="279.45927" y="451.67903"/>
                  <rect fill="#fff" height="36.06239" rx="18.03118" width="148.00427" x="553.59711" y="522.74315"/>
                  <path
...
export default {
  ...
  methods: {
    async signup() {
      const {email, nickname, password, confirmPassword} = this
